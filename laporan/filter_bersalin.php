...
<head>
	...
	<title>Cetak Data Bersalin</title>
</head>
	...
	<center>
		...
		<center>
			<table class="kop">
				...
				<td style="font-size: 30px; font-weight: bold;">Data Bersalin</td>
			</table>
		</center>
		<hr size="2px" color="black" style="margin-top: 1px;">
		<dv>
			...
			<table border="1" style="width: 100%;">
              ...
              <tbody>
                ...
                ";
                $sql = mysqli_query($koneksi, "SELECT data_bersalin.*, data_bidan.nama_bidan, data_pasien.nama_pasien FROM data_bersalin INNER JOIN data_bidan ON data_bidan.id=data_bersalin.id_bidan INNER JOIN data_pasien ON data_pasien.id=data_bersalin.id_pasien where month(data_bersalin.tgl_lahir) = " . $bulan . " and year(data_bersalin.tgl_lahir) = " . $tahun);
			...
			<table width="100%" align="right">
				...
				<tr>
					<th colspan="5" width="60%" align="right"></th>
					<th colspan="1" width="80%" align="centar">NIP. xxxxxxxxxxxxx</th>
				</tr>
			</table>
