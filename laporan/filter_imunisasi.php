		...
		<dv>
			...
			<table border="1" style="width: 100%;">
				...
				<tbody>
					...
					$bulan = $_GET['bulan'];
					$tahun = $_GET['tahun'];
					$sql = mysqli_query($koneksi, "SELECT data_imunisasi.*, data_jenis_imunisasi.nama AS jenis_imunisasi, data_bidan.nama_bidan, data_bayi.nama_bayi FROM data_imunisasi INNER JOIN data_jenis_imunisasi ON data_jenis_imunisasi.id=data_imunisasi.id_jenis_imunisasi INNER JOIN data_bidan ON data_bidan.id=data_imunisasi.id_bidan INNER JOIN data_bayi ON data_bayi.id=data_imunisasi.id_bayi where month(data_imunisasi.waktu_pemberian) = " . $bulan . " and year(data_imunisasi.waktu_pemberian) = " . $tahun);
