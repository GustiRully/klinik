...
<div class="container-fluid">
	<center>
		<table class="kop">
			...
			<tr>
				<td style="font-size: 25px; font-weight: bold;">KLINIK BIDAN LENI TRIYANA</td>
			</tr>
			<tr>
		...
		<dv>
			...
			<table border="1" style="width: 100%;">
				...
				<tbody>
					...
					$bulan = $_GET['bulan'];
					$tahun = $_GET['tahun'];
					$sql = mysqli_query($koneksi, "SELECT * FROM data_bidan where month(tmt) = " . $bulan . " and year(tmt) = " . $tahun);
			...
			<table width="100%" align="right">
				...
				<tr>
					<th colspan="5" width="60%" align="right"></th>
					<th colspan="1" width="80%" align="centar">NIP. xxxxxxxxx</th>
				</tr>
			</table>
