		...
		<dv>
			...
			<table border="1" style="width: 100%;">
              ...
              <tbody>
                ...
                ";
                $sql = mysqli_query($koneksi, "SELECT data_kehamilan.*, data_bidan.nama_bidan, data_pasien.nama_pasien FROM data_kehamilan INNER JOIN data_bidan ON data_bidan.id=data_kehamilan.id_bidan INNER JOIN data_pasien ON data_pasien.id=data_kehamilan.id_pasien where month(data_kehamilan.tanggal) = " . $bulan . " and year(data_kehamilan.tanggal) = " . $tahun);
