      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <h3 class="mb-0">Data Kehamilan</h3>
            <form method="post" action="laporan/kehamilan.php" target="_BLANK">
          ...
          <div style="margin-left: 20px">
            ...
            <form id="basic-form" method="post" action="kehamilan/proses.php" enctype="multipart/form-data" target="_blank">
              <div class="row">
                <div class="col">
                ...
                <div class="col" style="margin-top: 34px">
                  <button type="submit" class="btn btn-primary" name="cetak_filter_kehamilan">cetak</button>
                </div>
              </div>
          <!-- Light table -->
